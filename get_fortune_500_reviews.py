...
from src.indeed_scraper import get_indeed_reviews
from src.indeed_scraper import get_number_of_pages
hdr = {'User-Agent': 'Mozilla/5.0',
           'Cache-Control': 'no-cache'}


fortune_500_df = pd.read_csv('data/Fortune_500_URLS.csv')
